...
print("OPEN HASHING")
HashFunctions.hash_evaluation(OpenHash, "dataset(150).txt", item_to_delete, item_to_find)
#HashFunctions.hash_evaluation(OpenHash, "dataset(500).txt", item_to_delete, item_to_find)
#HashFunctions.hash_evaluation(OpenHash, "dataset(3000).txt", item_to_delete, item_to_find)
print("CHAIN HASHING")
HashFunctions.hash_evaluation(ChainHash, "dataset(150).txt", item_to_delete, item_to_find)
#HashFunctions.hash_evaluation(ChainHash, "dataset(500).txt", item_to_delete, item_to_find)
